...
#ifndef BSP_OVERRIDE_TRANSFER_REQUEST_T

/** Transfer request type selection when using DMAC */
typedef enum e_transfer_request
{
    TRANSFER_REQUEST_DMA_SOFTWARE = 0, ///< Transfer is triggered by software
    TRANSFER_REQUEST_DMA_HARDWARE = 1  ///< Transfer is triggered by hardware request
} transfer_request_t;
...
#ifndef BSP_OVERRIDE_TRANSFER_RELOAD_FUNCTION_1_T

/** Reload function 1 enables the transfer count (number of transfer) reloads at the end of DMA cycle,
...
#ifndef BSP_OVERRIDE_TRANSFER_RELOAD_FUNCTION_2_T

/** Reload function 2 enables the address reload count reloads at the end of DMA cycle, and source/destination address
...
{
    /** Pointer to transfer configuration options. If using chain transfer, this can be a pointer to
