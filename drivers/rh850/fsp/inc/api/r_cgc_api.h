...
#ifndef BSP_OVERRIDE_CGC_SYSTEM_CLOCK_BEHAVIOR_T
...
#ifndef BSP_OVERRIDE_CGC_SYSTEM_CLOCK_CFG_T

/** Clock configuration structure - Used as an input parameter to the @ref cgc_api_t::systemClockSet function for the system clock. */
typedef struct st_cgc_system_clock_cfg
{
    ...
    cgc_system_clock_behavior_t sscg1_clock_gear; ///< Gear behavior for CLK_SYS_SSCG1
...
typedef struct
{
    ...
    /** Shift the system clock gear.
     * @param[in]   p_ctrl              Pointer to instance control block
     * @param[in]   p_system_clock_cfg  Pointer to the system clock gear configuration
     */
    fsp_err_t (* systemClockGearSet)(cgc_ctrl_t * const                   p_ctrl,
                                     cgc_system_clock_cfg_t const * const p_system_clock_cfg);
     ...
     */
    fsp_err_t (* callbackSet)(cgc_ctrl_t * const p_ctrl, void (* p_callback)(cgc_callback_args_t * p_args),
