...
typedef enum e_adc_group_mask
{
    ...
    ADC_GROUP_MASK_PWM_DIAG = 0x200,   ///< Group Mask PWM-Diag - Used for ADCK
    ADC_GROUP_MASK_SG_DIAG  = 0x400,   ///< Group Mask SG-Diag - Used for ADCK
} adc_group_mask_t;
...
typedef struct st_adc_instance
{
    ...
    void const      * p_scan_group_cfg; ///< Pointer to the scan group configuration structure for this instance
