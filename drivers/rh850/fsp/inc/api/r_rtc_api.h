...
typedef enum e_rtc_event
{
    ...
    RTC_EVENT_ONE_SECOND_IRQ,          ///< Real Time Clock 01-Second IRQ
} rtc_event_t;
#endif
...
typedef struct st_rtc_cfg
{
    ...
    uint8_t   one_second_ipl;                           ///< One_second interrupt priority
    IRQn_Type one_second_irq;                           ///< One_second interrupt vector
...
typedef struct st_rtc_api
{
     ...
     * @param[in]  p_err_adj_cfg   Pointer to the Error Adjustment Config
     */
    fsp_err_t (* errorAdjustmentSet)(rtc_ctrl_t * const p_ctrl, rtc_error_adjustment_cfg_t const * const p_err_adj_cfg);
