 ...
 * 16 bit, 32 bit and 64 bit variations. Calculation can be performed by sending data to the block using the CPU or by snooping
...
#ifndef BSP_OVERRIDE_CRC_BIT_ORDER_T
...
#ifndef BSP_OVERRIDE_CRC_RESULT_T
...
typedef struct st_crc_api
{
     ...
     *
     * @param[in]  p_ctrl              Pointer to CRC device handle.
     * @param[out] p_crc_result        The calculated value from the last CRC calculation.
     **/
    fsp_err_t (* crcResultGet)(crc_ctrl_t * const p_ctrl, crc_result_t * p_crc_result);
     ...
     * @param[out] p_crc_result   The calculated value of the CRC calculation.
     **/
    fsp_err_t (* calculate)(crc_ctrl_t * const p_ctrl, crc_input_t * const p_crc_input, crc_result_t * p_crc_result);
} crc_api_t;
