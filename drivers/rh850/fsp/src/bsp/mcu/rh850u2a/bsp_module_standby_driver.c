...
const bsp_module_standby_info_t g_msr_info_table[] =
{
    ...
    [BSP_MODULE_STANDBY_MSR_ETNB] =
    {
    .msr_reg_address   = (uint32_t *) &(R_SYS0_STBC->MSR_ETNB),
    .default_value     = BSP_MODULE_STANDBY_MSR_ETNB_DEFAULT_VALUE,
    .initial_cfg_value = BSP_MODULE_STANDBY_MSR_ETNB_ENABLE
    },
    ...
    [BSP_MODULE_STANDBY_MSR_ADCJ_ISO] =
    {
    .msr_reg_address   = (uint32_t *) &(R_SYS0_STBC->MSR_ADCJ_ISO),
    .default_value     = BSP_MODULE_STANDBY_MSR_ADCJ_ISO_DEFAULT_VALUE,
    .initial_cfg_value = BSP_MODULE_STANDBY_MSR_ADCJ_ISO_ENABLE
    },
    ...
    .default_value     = BSP_MODULE_STANDBY_MSR_RHSIF_DEFAULT_VALUE,
    ...
    .default_value     = BSP_MODULE_STANDBY_MSR_RIIC_DEFAULT_VALUE,
    .initial_cfg_value = BSP_MODULE_STANDBY_MSR_RIIC_ENABLE
    },
#if (BSP_FEATURE_SCI3_IS_AVAILABLE)
    [BSP_MODULE_STANDBY_MSR_SCI3] =
    {
    .msr_reg_address   = (uint32_t *) &(R_SYS0_STBC->MSR_SCI3),
    .default_value     = BSP_MODULE_STANDBY_MSR_SCI3_DEFAULT_VALUE,
    .initial_cfg_value = BSP_MODULE_STANDBY_MSR_SCI3_ENABLE
    },
    ...
    .default_value     = BSP_MODULE_STANDBY_MSR_TPBA_DEFAULT_VALUE,
    ...
    [BSP_MODULE_STANDBY_MSR_ADCJ_AWO] =
    {
