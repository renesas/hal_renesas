...
#define BSP_GUARD_READ_WRITE_ACCESS              0x153                  ///< Full read/write access (Supervisor/User)

#define BSP_GUARD_CHANNEL_DEFAULT                (0)                    ///< Default guard channel

#define BSP_GUARD_KCPROT_ADDRESS_OFFSET          0x18                   ///< KCPROT register offset

#define BSP_PBG_CHANNEL_ADDRESS_OFFSET           0x08                   ///< PBG channel offset
#define BSP_PBG_KCPROT_ADDRESS_OFFSET            0x18                   ///< PBG KCPROT offset
...
#define R_GUARD_CRG_CRAM1_BASE                   0xFE100000UL           ///< CRG shared RAM1 base
#define R_GUARD_CRG_CRAM2_BASE                   0xFE400000UL           ///< CRG shared RAM2 base
#define R_GUARD_CRG_CRAM3_BASE                   0xFE800000UL           ///< CRG shared RAM3 base
...
#define R_IBG00_IPIGPROT0_4_BASE                 0xFFC6A2C0UL           ///< IBG00 IPIGPROT0 index 4 base

#define R_IBG01_BRGPROT0_n_BASE                  0xFFC6A080UL           ///< IBG01 BRGPROT0 n base
#define R_IBG01_BRGPROT0_16_BASE                 0xFFC6A100UL           ///< IBG01 BRGPROT0 index 16 base

#define R_IBG02_TPTGPROT0_n_BASE                 0xFFC6A680UL           ///< IBG02 TPTGPROT0 n base
#define R_IBG02_TPTGPROT0_8_BASE                 0xFFC6A6C0UL           ///< IBG02 TPTGPROT0 index 8 base
#define R_IBG02_TPTGPROT0_9_BASE                 0xFFC6A6C8UL           ///< IBG02 TPTGPROT0 index 9 base

#define BSP_GUARD_MAX_32BITS                     0xFFFFFFFFUL           ///< Full 32-bit mask

#define BSP_IBG_CONTROL_TPTM_U8                  BSP_IBG_CONTROL_TPTM_8 ///< Alias for TPTM_8
#define BSP_IBG_CONTROL_TPTM_U9                  BSP_IBG_CONTROL_TPTM_9 ///< Alias for TPTM_9
#define DMAGPROT_GR_DP_CR_CTR                    DMAGPROT_GR_DP_CTR     ///< Compatibility alias

#define BSP_GUARD_GET_BIT(value)    (__SCH1R(value) - 1)                ///< Search bit 1 from the LSB

/*******************************************************************************************************************//**
 * @ingroup BSP_MCU_RH850U2AX
 * @defgroup BSP_GUARD_U2AX BSP Guard Protection
 *
 * @{
 **********************************************************************************************************************/
...
{
    BSP_PBG_GROUP_PBG00,               ///< PBG group PBG00
    ...
    BSP_PBG_GROUP_PBG33,               ///< PBG group PBG33
    ...
    BSP_PBG_GROUP_PBG53,               ///< PBG group PBG53
    BSP_PBG_GROUP_PBG6L0,              ///< PBG group PBG6L0
    BSP_PBG_GROUP_PBG6L1,              ///< PBG group PBG6L1
    BSP_PBG_GROUP_PBG6H0,              ///< PBG group PBG6H0
    BSP_PBG_GROUP_PBG70,               ///< PBG group PBG70
    BSP_PBG_GROUP_PBG80,               ///< PBG group PBG80
...
{
    BSP_GUARD_BSP_MODULE,              ///< BSP
    BSP_GUARD_BIST_MODULE,             ///< BIST
    BSP_GUARD_TAUJ_MODULE,             ///< TAUJ
    BSP_GUARD_LPS_MODULE,              ///< LPS
    BSP_GUARD_ADC_MODULE,              ///< ADC
    BSP_GUARD_RTCA_MODULE,             ///< RTCA
    BSP_GUARD_WDTBA_MODULE,            ///< WDTBA
    BSP_GUARD_PORT_MODULE,             ///< PORT
    BSP_GUARD_PSI5_MODULE,             ///< PSI5
    BSP_GUARD_PSI5S_MODULE,            ///< PSI5S
#if (BSP_FEATURE_SCI3_IS_AVAILABLE)
    BSP_GUARD_SCI3_MODULE,             ///< SCI3
#endif /* #if (BSP_FEATURE_SCI3_IS_AVAILABLE) */
    BSP_GUARD_ECM_MODULE,              ///< ECM
    BSP_GUARD_KCRC_MODULE,             ///< KCRC
#if (BSP_FEATURE_CXPI_IS_AVAILABLE)
    BSP_GUARD_CXPI_MODULE,             ///< CXPI
#endif /* #if (BSP_FEATURE_CXPI_IS_AVAILABLE) */
    BSP_GUARD_RSENT_MODULE,            ///< RSENT
#if (BSP_FEATURE_MMCA_IS_AVAILABLE)
    BSP_GUARD_MMCA_MODULE,             ///< MMCA
#endif /* #if (BSP_FEATURE_MMCA_IS_AVAILABLE) */
    BSP_GUARD_RLIN3_MODULE,            ///< RLIN3
    BSP_GUARD_RSCFD_MODULE,            ///< RSCFD
    BSP_GUARD_MSPI_MODULE,             ///< MSPI
    BSP_GUARD_WTDB_MODULE,             ///< WTDB
    BSP_GUARD_LTSC_MODULE,             ///< LTSC
    BSP_GUARD_OSTM_MODULE,             ///< OSTM
    BSP_GUARD_TAUD_MODULE,             ///< TAUD
    BSP_GUARD_TSG_MODULE,              ///< TSG
#if (BSP_FEATURE_ENCA_IS_AVAILABLE)
    BSP_GUARD_ENCA_MODULE,             ///< ENCA
#endif /* #if (BSP_FEATURE_ENCA_IS_AVAILABLE) */
    BSP_GUARD_TAPA_MODULE,             ///< TAPA
    BSP_GUARD_TPBA_MODULE,             ///< TPBA
    BSP_GUARD_PIC_MODULE,              ///< PIC
    BSP_GUARD_FLASH_MODULE,            ///< FLASH
    BSP_GUARD_OTS_MODULE,              ///< OTS
    BSP_GUARD_EINT_MODULE,             ///< EINT
    BSP_GUARD_PWM_MODULE,              ///< PWM
    BSP_GUARD_FLMD_MODULE,             ///< FLMD
    BSP_GUARD_FACI_MODULE,             ///< FACI
    BSP_GUARD_GTM_MODULE,              ///< GTM
    BSP_GUARD_RIIC_MODULE,             ///< RIIC
#if (BSP_FEATURE_RHSIF_IS_AVAILABLE)
    BSP_GUARD_RHSIF_MODULE,            ///< RHSIF
#endif /* #if (BSP_FEATURE_RHSIF_IS_AVAILABLE) */
    BSP_GUARD_SPIDCTL_MODULE,          ///< SPIDCTL
    BSP_GUARD_DMA_MODULE,              ///< DMA
    BSP_GUARD_DTS_MODULE,              ///< DTS
    BSP_GUARD_ICUM_MODULE,             ///< ICUM
#if (BSP_FEATURE_ETNB_IS_AVAILABLE)
    BSP_GUARD_ETNB_MODULE,             ///< ETNB
#endif /* #if (BSP_FEATURE_ETNB_IS_AVAILABLE) */
#if (BSP_FEATURE_FLXA_IS_AVAILABLE)
    BSP_GUARD_FLXA_MODULE,             ///< FLXA
#endif /* #if (BSP_FEATURE_FLXA_MAX_UNIT) */
#if (BSP_FEATURE_SFMA_IS_AVAILABLE)
    BSP_GUARD_SFMA_MODULE,             ///< SFMA
#endif /* #if (BSP_FEATURE_SFMA_IS_AVAILABLE) */
    BSP_MODULE_PBG_TOTAL_INDEX_END     ///< TOTAL
} bsp_module_pbg_id_t;
...
{
    BSP_IBG_CONTROL_IPIR_Rn = 0,       ///< I-Bus group0 (Rn)
    BSP_IBG_CONTROL_IPIR_Tn,           ///< I-Bus group0 (Tn)
    BSP_IBG_CONTROL_IPIR_4,            ///< I-Bus group0 ( 4)
    BSP_IBG_CONTROL_BARR_n,            ///< I-Bus group1 (n)
    BSP_IBG_CONTROL_BARR_16,           ///< I-Bus group1 (16)
    BSP_IBG_CONTROL_TPTM_n,            ///< I-Bus group2 (n)
    BSP_IBG_CONTROL_TPTM_8,            ///< I-Bus group2 (8)
    BSP_IBG_CONTROL_TPTM_9,            ///< I-Bus group2 (9)
    BSP_IBG_CONTROL_NUM
} bsp_ibg_control_t;
...
typedef enum e_bsp_crg_control
{
    ...
    BSP_CRG_CONTROL_CRAM2,             ///< Guard for Cluster 2 RAM
    BSP_CRG_CONTROL_CRAM3,             ///< Guard for Cluster 2 RAM
    BSP_CRG_CONTROL_NUM
} bsp_crg_control_t;
...
typedef struct st_bsp_ibg_protection_setting
{
     ...
     *  - IPIR (Rn/Tn/4), BarrierSync (n/16), or TPTM (n/8/9)
     */
    bsp_ibg_control_t control;

    /** Specifies channel number for channel-based targets. Ignored for common targets (IPIR_4, BARR_16, TPTM_8, TPTM_9) */
    uint8_t channel;
...
typedef struct st_bsp_peg_protection_status
{
    ...
    /**
     * PEG protection status for PEx (x = 0,1,2,3,4,5 / If the device is available)
     *
...
typedef struct st_bsp_crg_protection_status
{
    ...
    /**
     * CRG protection status for Cluster RAM n (n = 0,1,2,4 / If the device is available):
     *
