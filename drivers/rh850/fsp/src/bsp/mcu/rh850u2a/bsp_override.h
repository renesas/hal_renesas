 ...
 * @defgroup BSP_OVERRIDE_U2AX BSP Type Override Definitions
 *
 * @{
 **********************************************************************************************************************/
...
typedef enum e_uart_event
{
    ...
    UART_EVENT_TX_DATA_EMPTY = 0x80,   ///< Transmit data empty event
    UART_EVENT_BREAK_DETECT  = 0x100,  ///< Break detect event
...
typedef enum e_ioport_filter_signal
{
    ...
    IOPORT_FILTER_SIGNAL_FLXA1RXDA,            ///< Select Enable Noise Filter FLXA1RXDA
    ...
    IOPORT_FILTER_SIGNAL_ADCJ0TRG0,            ///< Select Enable Noise Filter ADCJ0TRG0
    IOPORT_FILTER_SIGNAL_ADCJ0TRG1,            ///< Select Enable Noise Filter ADCJ0TRG1
    IOPORT_FILTER_SIGNAL_ADCJ0TRG2,            ///< Select Enable Noise Filter ADCJ0TRG2
    IOPORT_FILTER_SIGNAL_ADCJ0TRG3,            ///< Select Enable Noise Filter ADCJ0TRG3
    IOPORT_FILTER_SIGNAL_ADCJ0TRG4,            ///< Select Enable Noise Filter ADCJ0TRG4
    IOPORT_FILTER_SIGNAL_ADCJ1TRG0,            ///< Select Enable Noise Filter ADCJ1TRG0
    IOPORT_FILTER_SIGNAL_ADCJ1TRG1,            ///< Select Enable Noise Filter ADCJ1TRG1
    IOPORT_FILTER_SIGNAL_ADCJ1TRG2,            ///< Select Enable Noise Filter ADCJ1TRG2
    IOPORT_FILTER_SIGNAL_ADCJ1TRG3,            ///< Select Enable Noise Filter ADCJ1TRG3
    IOPORT_FILTER_SIGNAL_ADCJ1TRG4,            ///< Select Enable Noise Filter ADCJ1TRG4
    IOPORT_FILTER_SIGNAL_ADCJ2TRG0,            ///< Select Enable Noise Filter ADCJ2TRG0
    IOPORT_FILTER_SIGNAL_ADCJ2TRG1,            ///< Select Enable Noise Filter ADCJ2TRG1
    IOPORT_FILTER_SIGNAL_ADCJ2TRG2,            ///< Select Enable Noise Filter ADCJ2TRG2
    IOPORT_FILTER_SIGNAL_ADCJ2TRG3,            ///< Select Enable Noise Filter ADCJ2TRG3
    IOPORT_FILTER_SIGNAL_ADCJ2TRG4,            ///< Select Enable Noise Filter ADCJ2TRG4
    ...
    IOPORT_FILTER_SIGNAL_INTP0,                ///< Select Enable Noise Filter INTP0
    IOPORT_FILTER_SIGNAL_INTP1,                ///< Select Enable Noise Filter INTP1
    IOPORT_FILTER_SIGNAL_INTP2,                ///< Select Enable Noise Filter INTP2
    IOPORT_FILTER_SIGNAL_INTP3,                ///< Select Enable Noise Filter INTP3
    IOPORT_FILTER_SIGNAL_INTP4,                ///< Select Enable Noise Filter INTP4
    IOPORT_FILTER_SIGNAL_INTP5,                ///< Select Enable Noise Filter INTP5
    IOPORT_FILTER_SIGNAL_INTP6,                ///< Select Enable Noise Filter INTP6
    IOPORT_FILTER_SIGNAL_INTP7,                ///< Select Enable Noise Filter INTP7
    IOPORT_FILTER_SIGNAL_INTP8,                ///< Select Enable Noise Filter INTP8
    IOPORT_FILTER_SIGNAL_INTP9,                ///< Select Enable Noise Filter INTP9
    IOPORT_FILTER_SIGNAL_INTP10,               ///< Select Enable Noise Filter INTP10
    IOPORT_FILTER_SIGNAL_INTP11,               ///< Select Enable Noise Filter INTP11
    IOPORT_FILTER_SIGNAL_INTP12,               ///< Select Enable Noise Filter INTP12
    IOPORT_FILTER_SIGNAL_INTP13,               ///< Select Enable Noise Filter INTP13
    IOPORT_FILTER_SIGNAL_INTP14,               ///< Select Enable Noise Filter INTP14
    IOPORT_FILTER_SIGNAL_INTP15,               ///< Select Enable Noise Filter INTP15
    IOPORT_FILTER_SIGNAL_INTP16,               ///< Select Enable Noise Filter INTP16
    IOPORT_FILTER_SIGNAL_INTP17,               ///< Select Enable Noise Filter INTP17
    IOPORT_FILTER_SIGNAL_INTP18,               ///< Select Enable Noise Filter INTP18
    IOPORT_FILTER_SIGNAL_INTP19,               ///< Select Enable Noise Filter INTP19
    IOPORT_FILTER_SIGNAL_INTP20,               ///< Select Enable Noise Filter INTP20
    IOPORT_FILTER_SIGNAL_INTP21,               ///< Select Enable Noise Filter INTP21
    IOPORT_FILTER_SIGNAL_INTP22,               ///< Select Enable Noise Filter INTP22
    IOPORT_FILTER_SIGNAL_INTP23,               ///< Select Enable Noise Filter INTP23
    IOPORT_FILTER_SIGNAL_INTP24,               ///< Select Enable Noise Filter INTP24
    IOPORT_FILTER_SIGNAL_INTP25,               ///< Select Enable Noise Filter INTP25
    IOPORT_FILTER_SIGNAL_INTP26,               ///< Select Enable Noise Filter INTP26
    IOPORT_FILTER_SIGNAL_INTP27,               ///< Select Enable Noise Filter INTP27
    IOPORT_FILTER_SIGNAL_INTP28,               ///< Select Enable Noise Filter INTP28
    IOPORT_FILTER_SIGNAL_INTP29,               ///< Select Enable Noise Filter INTP29
    IOPORT_FILTER_SIGNAL_INTP30,               ///< Select Enable Noise Filter INTP30
    IOPORT_FILTER_SIGNAL_INTP31,               ///< Select Enable Noise Filter INTP31
    IOPORT_FILTER_SIGNAL_INTP32,               ///< Select Enable Noise Filter INTP32
    IOPORT_FILTER_SIGNAL_INTP33,               ///< Select Enable Noise Filter INTP33
    IOPORT_FILTER_SIGNAL_INTP34,               ///< Select Enable Noise Filter INTP34
    IOPORT_FILTER_SIGNAL_INTP35,               ///< Select Enable Noise Filter INTP35
    IOPORT_FILTER_SIGNAL_INTP36,               ///< Select Enable Noise Filter INTP36
    IOPORT_FILTER_SIGNAL_INTP37,               ///< Select Enable Noise Filter INTP37
    IOPORT_FILTER_SIGNAL_INTP38,               ///< Select Enable Noise Filter INTP38
    IOPORT_FILTER_SIGNAL_INTP39,               ///< Select Enable Noise Filter INTP39
    IOPORT_FILTER_SIGNAL_INTP_NMI,             ///< Select Enable Noise Filter INTP NMI
...
typedef enum e_cgc_clock
{
    ...
    CGC_CLOCK_HOCO     = 2,            ///< The high speed on chip oscillator
    CGC_CLOCK_LOCO     = 3,            ///< The low speed on chip oscillator
    CGC_CLOCK_HVIO     = 4,            ///< The high voltage internal oscillator
} cgc_clock_t;
...
{
    cgc_system_clock_behavior_t sys_clock_gear; ///< Gear behavior for CLK_SYS
