...
void bsp_clock_driver_init (void)
{
    ...
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_CLOCK->CKS_RLINS,
                               (BSP_CFG_CLOCK_CLK_RLIN323_SRC << 16) | (BSP_CFG_CLOCK_CLK_RLIN3_SRC));
    ...
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_CLOCK->CKS_SWDTS, BSP_CFG_CLOCK_CLK_SWDT_SRC);

    /* CLKC_CANXL_CH0 selector setting */
    R_SYS0_CLOCK->CKS_CANXL0C = BSP_CFG_CLOCK_CLKC_CANXL_CH0_SRC;
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_CLOCK->CKS_CANXL0S, BSP_CFG_CLOCK_CLKC_CANXL_CH0_SRC);

#if (BSP_FEATURE_CANXL_CH1_IS_AVAILABLE)

    /* CLKC_CANXL_CH1 selector setting */
    R_SYS0_CLOCK->CKS_CANXL1C = BSP_CFG_CLOCK_CLKC_CANXL_CH1_SRC;
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_CLOCK->CKS_CANXL1S, BSP_CFG_CLOCK_CLKC_CANXL_CH1_SRC);
#endif                                 /* #if (BSP_FEATURE_CANXL_CH1_IS_AVAILABLE) */

    /* CLKA_WDTBA selector setting */
    R_SYS0_A_CLOCK->CKS_AWDTC = BSP_CFG_CLOCK_CLKA_WDTBA_SRC;
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_A_CLOCK->CKS_AWDTS, BSP_CFG_CLOCK_CLKA_WDTBA_SRC);

    /* CLKA_TAUJ selector setting */
    R_SYS0_A_CLOCK->CKS_ATAUJC = BSP_CFG_CLOCK_CLKA_TAUJ_SRC;
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_A_CLOCK->CKS_ATAUJS, BSP_CFG_CLOCK_CLKA_TAUJ_SRC);

    /* CLKA_RTCA selector setting */
    R_SYS0_A_CLOCK->CKS_ARTCAC = BSP_CFG_CLOCK_CLKA_RTCA_SRC;
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_A_CLOCK->CKS_ARTCAS, BSP_CFG_CLOCK_CLKA_RTCA_SRC);

    /* CLKA_ADC selector setting */
    R_SYS0_A_CLOCK->CKS_AADCC = BSP_CFG_CLOCK_CLKA_ADC_SRC;
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_A_CLOCK->CKS_AADCS, BSP_CFG_CLOCK_CLKA_ADC_SRC);
