...
void bsp_cyclicrun_clock_driver_init (void)
{
    ...
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_CLOCK->CKS_RLINS,
                               (BSP_CFG_CLOCK_CYCLICRUN_CLK_RLIN323_SRC << 16) |
                               (BSP_CFG_CLOCK_CYCLICRUN_CLK_RLIN3_SRC));
    ...
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_A_CLOCK->CKS_AWDTS, BSP_CFG_CLOCK_CYCLICRUN_CLKA_WDTBA_SRC);

    /* CLKA_TAUJ selector setting */
    R_SYS0_A_CLOCK->CKS_ATAUJC = BSP_CFG_CLOCK_CYCLICRUN_CLKA_TAUJ_SRC;
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_A_CLOCK->CKS_ATAUJS, BSP_CFG_CLOCK_CYCLICRUN_CLKA_TAUJ_SRC);

    /* CLKA_RTCA selector setting */
    R_SYS0_A_CLOCK->CKS_ARTCAC = BSP_CFG_CLOCK_CYCLICRUN_CLKA_RTCA_SRC;
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_A_CLOCK->CKS_ARTCAS, BSP_CFG_CLOCK_CYCLICRUN_CLKA_RTCA_SRC);

    /* CLKA_ADC selector setting */
    R_SYS0_A_CLOCK->CKS_AADCC = BSP_CFG_CLOCK_CYCLICRUN_CLKA_ADC_SRC;
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_A_CLOCK->CKS_AADCS, BSP_CFG_CLOCK_CYCLICRUN_CLKA_ADC_SRC);
    ...
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_A_CLOCK->CKS_EXTCLK0S, BSP_CFG_CLOCK_CYCLICRUN_EXTCLK0O_SRC);
    ...
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_A_CLOCK->CKS_EXTCLK1S, BSP_CFG_CLOCK_CYCLICRUN_EXTCLK1O_SRC);
    ...
    FSP_HARDWARE_REGISTER_WAIT(R_SYS0_A_CLOCK->CKS_WDTS, BSP_CFG_CLOCK_CYCLICRUN_CLK_WDTB_SRC);
