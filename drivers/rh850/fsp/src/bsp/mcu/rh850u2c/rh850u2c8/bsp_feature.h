...
/** GTM */
#define BSP_FEATURE_GTM_MCS_NUMBER_INSTANCE                                   (2U)                         ///< GTM MCS instances
...
/** VMON */
#define BSP_FEATURE_VMON_VDD2_GROUP                                           (0U)                         ///< VDD2 monitoring group
#define BSP_FEATURE_VMON_AWOVDD_GROUP                                         (1U)                         ///< AWOVDD monitoring group
