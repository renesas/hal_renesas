...
/** ECM Error Factor */
typedef enum e_ecm_error_source_u2b6
{
    ...
    ECM_ERROR_SOURCE_EMU3S0_COMPARE_ERROR                            = (38),       ///< EMU3S0 Compare error
    ECM_ERROR_SOURCE_EMU3S1_COMPARE_ERROR                            = (39),       ///< EMU3S1 Compare error
    ...
    ECM_ERROR_SOURCE_CLK_HBUS_CLKC_HSB_EMU3S0_CLOCK                  = (76),       ///< Clock monitor error for CLK_HBUS / CLKC_HSB (EMU3S0 clock)
    ECM_ERROR_SOURCE_CLOCK_MONITOR_ERROR_FOR_CLKC_LSB                = (77),       ///< Clock monitor error for CLKC_LSB
    ECM_ERROR_SOURCE_CLK_HBUS_CLKC_HSB_EMU3S1_CLOCK                  = (78),       ///< Clock monitor error for CLK_HBUS / CLKC_HSB (EMU3S1 clock)
