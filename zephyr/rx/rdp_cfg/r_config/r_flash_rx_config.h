 ...
 */
#define FLASH_CFG_CODE_FLASH_ENABLE ((DT_PROP(DT_NODELABEL(code_flash), renesas_programming_enable)))
 ...
 * function. 
 */
#define FLASH_CFG_DATA_FLASH_BGO   ((DT_PROP(DT_NODELABEL(data_flash), renesas_bgo_enable)))
