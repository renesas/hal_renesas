...
/*******************************************************************************************************************//**
 * @file     core_g4kh.h
 * @brief    RH850 G4KH Core Definitions
 * @version  V0.0.2
 * @date     24 Jun 2026
 **********************************************************************************************************************/

#ifndef __CORE_RH850_G4KH_H_GENERIC
 #define __CORE_RH850_G4KH_H_GENERIC
...
/**
 * @defgroup RH850_G4KH RH850 G4KH
...
/**
 * @ingroup    RH850_G4KH
 * @defgroup   RH850_G4KH_Device_Capability_Def  RH850 Device capabilitiy defines
...
/* RH850 RH850_G4KH definitions */

 #define __RH850_G4KH    (1)           /*!< RH850 G4KH Core */
 ...
 */
  ...
  #else
   #define __FPU_USED    0U            /*!< FPU used or not */
  #endif

/** __FXU_USED indicates whether an FXU is used or not.
 */
  #if defined(__FXU)
   #define __FXU_USED    1U            /*!< FXU used or not */
  #else
   #define __FXU_USED    0U            /*!< FXU used or not */
  #endif
 #endif
...
#endif                                 /* __CORE_RH850_G4KH_H_GENERIC */

#ifndef __RH850_GENERIC

 #ifndef __CORE_RH850_G4KH_H_DEPENDANT
  #define __CORE_RH850_G4KH_H_DEPENDANT
...
/* check device defines and use defaults */
   ...
   #ifndef __RH850_G4KH_REV
    #define __RH850_G4KH_REV    0x08U  /*!< RH850 G4KH Core revision */
    #warning "__RH850_G4KH_REV not defined in device header file; using default!"
   #endif
...
/**
 * @ingroup    RH850_G4KH
 * @defgroup   RH850_G4KH_IO_Type_Qualifiers  RH850 IO Type Qualifiers
...
/**
 * @defgroup RH850_G4KH_core_register Defines and Type Definitions
 * @ingroup  RH850_G4KH_Core_register
 *
 * @brief Type definitions and defines for RH850 G4KH processor based devices.
 */

/**
 * @ingroup    RH850_G4KH_core_register
 * @defgroup   RH850_G4KH_CORE  Status and Control Registers
 ...
 **********************************************************************************************************************/
  ...
  #define SR_FPEC        11            /*!< RegID: Floating-point exception control (FPEC) (SR11, 0) */
  #define SL_FPEC        0             /*!< SelID: Floating-point exception control (FPEC) (SR11, 0) */
 ...
 **********************************************************************************************************************/
  ...
  #define SR_PMCTRL0     17            /*!< RegID: Performance count control 0 register (SR17, 11) */
  #define SL_PMCTRL0     11            /*!< SelID: Performance count control 0 register (SR17, 11) */
  #define SR_PMCTRL1     19            /*!< RegID: Performance count control 1 register (SR19, 11) */
  #define SL_PMCTRL1     11            /*!< SelID: Performance count control 1 register (SR19, 11) */
  #define SR_PMCTRL2     21            /*!< RegID: Performance count control 2 register (SR21, 11) */
  #define SL_PMCTRL2     11            /*!< SelID: Performance count control 2 register (SR21, 11) */
  #define SR_PMCTRL3     23            /*!< RegID: Performance count control 3 register (SR23, 11) */
  #define SL_PMCTRL3     11            /*!< SelID: Performance count control 3 register (SR23, 11) */
  #define SR_PMCOUNT0    16            /*!< RegID: Performance count 0 register (SR16, 11) */
  #define SL_PMCOUNT0    11            /*!< SelID: Performance count 0 register (SR16, 11) */
  #define SR_PMCOUNT1    18            /*!< RegID: Performance count 1 register (SR18, 11) */
  #define SL_PMCOUNT1    11            /*!< SelID: Performance count 1 register (SR18, 11) */
  #define SR_PMCOUNT2    20            /*!< RegID: Performance count 2 register (SR20, 11) */
  #define SL_PMCOUNT2    11            /*!< SelID: Performance count 2 register (SR20, 11) */
  #define SR_PMCOUNT3    22            /*!< RegID: Performance count 3 register (SR22, 11) */
  #define SL_PMCOUNT3    11            /*!< SelID: Performance count 3 register (SR22, 11) */
...
/**
 * @ingroup    RH850_G4KH_core_register
 * @defgroup   RH850_G4KH_core_bitfield     Core register bit field macros
...
/**
 * @defgroup  RH850_G4KH_Core_register RH850 G4KH Core Register
 * @brief RH850 G4KH Core Register
...
/**
 * @ingroup  RH850_G4KH_Core_register
 * @defgroup RH850_G4KH_SYS     Basic System Register (SYS)
...
typedef union
{
    ...
    struct
    {
        __IOM uint32_t SPID : 5;       /*!< [4..0] These bits indicate the system protection identifier.The
                                        ...
                                        *    of initial value for G4KH register.Within this CPU, the
...
/*@}*/ /* end of group RH850_G4KH_SYS */

/**
 * @ingroup  RH850_G4KH_Core_register
 * @defgroup RH850_G4KH_IRQ     Interrupt Function Registers (IRQ)
...
/*@}*/ /* end of group RH850_G4KH_IRQ */

/**
 * @ingroup  RH850_G4KH_Core_register
 * @defgroup RH850_G4KH_FPU     FPU Function Registers (FPU)
...
typedef union
{
    __IOM uint32_t FPEC;               /*!< (@ 0x00000000) Floating-point Exception Program Counter                   */

    struct
    {
        __IM uint32_t FPEC : 1;        /*!< [0..0] This bit indicates the status of reporting the FPl exception.
                                        * If this bit is set to 1, the FPl exception is reported to the CPU but is not
                                        * acknowledged. It is automatically cleared to 0 when the CPU acknowledges
                                        * the FPl exception.
                                        * While this bit is set to 1, all the floating-point instructions are invalidated.
                                        * Report of the FPl exception can be canceled by clearing (0) this bit by the
                                        * LDSR instruction while it is set to 1. When report of the FPl exception is
                                        * canceled, the CPU does not acknowledge the FPl exception.
                                        * 0. FPl exception is not reported.
                                        * 1: FPl exception is reported..              */
        uint32_t : 31;
    } FPEC_b;
} RH850_FPU_FPEC_Type;
...
/* =========================================================  FPEC   ================================================ */
  #define R_FPU_FPEC_FPIVD_Pos      (0UL)          /*!< FPIVD (Bit 0)                                                 */
  #define R_FPU_FPEC_FPIVD_Msk      (0x1UL)        /*!< FPIVD (Bitfield-Mask: 0x01)                                   */

/*@}*/ /* end of group RH850_G4KH_FPU */

/**
 * @ingroup  RH850_G4KH_Core_register
 * @defgroup RH850_G4KH_MPU     MPU Function Registers (MPU)
...
/*@}*/ /* end of group RH850_G4KH_MPU */

/**
 * @ingroup  RH850_G4KH_Core_register
 * @defgroup RH850_G4KH_ICACHE     Cache Operation Function Registers (ICACHE)
...
/*@}*/ /* end of group RH850_G4KH_ICACHE */

/**
 * @ingroup  RH850_G4KH_Core_register
 * @defgroup RH850_G4KH_PMU     Count Function Registers (PMU)
...
/*@}*/ /* end of group RH850_G4KH_PMU */

/**
 * @ingroup  RH850_G4KH_Core_register
 * @defgroup RH850_G4KH_HWF     Hardware Function Registers (HWF)
...
/*@}*/ /* end of group RH850_G4KH_HWF */

/**
 * @ingroup  RH850_G4KH_Core_register
 * @defgroup RH850_G4KH_TSC     Timestamp counter (TSC)
...
/*@}*/ /* end of group RH850_G4KH_TSC */

/*@}*/ /* end of group RH850_G4KH_Core_register */
/*@}*/ /* end of group G4KH_Core_register */
 ...
 * @defgroup RH850_G4KH_API_Funcs RH850 G4KH Macro Wrapper API Functions
 * @brief RH850 G4KH Macro Wrapper API Functions
...
/**
 * @defgroup RH850_G4KH_FPU_API FPU API Functions
 * @brief FPU API Functions
 * @ingroup RH850_G4KH_API_Funcs
 * @{
 */
...
/**
 * @defgroup RH850_G4KH_ICACHE_API ICACHE API Functions
...
/**
 * @defgroup RH850_G4KH_IRQ_API IRQ API Functions
...
/**
 * @defgroup RH850_G4KH_MPU_API MPU API Functions
...
/**
 * @defgroup RH850_G4KH_PMU_API PMU API Functions
...
/**
 * @defgroup RH850_G4KH_TSC_API TSC API Functions
...
/** @} */ /* end of RH850_G4KH_API_Funcs */

  #ifdef __cplusplus
}
  #endif

 #endif                                /* __CORE_RH850_G4KH_H_DEPENDANT */
