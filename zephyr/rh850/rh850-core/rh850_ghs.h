...
/*******************************************************************************************************************//**
 * @file     rh850_ghs.h
 * @brief    RH850 compiler GHS header file
 * @version  V0.0.2
 * @date     24 Jun 2026
 **********************************************************************************************************************/

#ifndef __RH850_GHS_H
#define __RH850_GHS_H
...
/* Create the pragma inline statement with the function name as argument */
 ...
 #define __PRAGMA_PLACE_IN_SECTION(sec, name)    __PRAGMA_HELPER(ghs section sec = name)
#endif
 ...
 *  @defgroup GHS_RH850_Core_InstructionInterface GHS RH850-Core Instruction Interface
 ...
 */
#define __ISB()    __ASM volatile ("synci" ::: "memory")
 ...
 * @note    Keep RH850 function name and ensure identical behavior on RH850.
 */
#define __DSB()    __ASM volatile ("syncp" ::: "memory")
 ...
 * @note    Keep RH850 function name and ensure identical behavior on RH850.
 */
#define __DMB()    __ASM volatile ("syncm" ::: "memory")
...
__STATIC_FORCEINLINE uint32_t __REV (uint32_t value)
{
    ...
    __ASM volatile ("bsw  %1, %0" : "=&r" (result) : "r" (value) : "memory");
...
__STATIC_FORCEINLINE uint32_t __REV16 (uint32_t value)
{
    ...
    __ASM volatile ("bsh  %1, %0" : "=&r" (result) : "r" (value) : "memory");
 ...
 * @note    Keep RH850 function name and ensure identical behavior on RH850.
 */
#define __LDREXB(addr)           (uint8_t) __LDL_BU((unsigned char *) addr)
 ...
 * @note    Keep RH850 function name and ensure identical behavior on RH850.
 */
#define __LDREXH(addr)           (uint16_t) __LDL_HU((unsigned short *) addr)
 ...
 * @note    Keep RH850 function name and ensure identical behavior on RH850.
 */
#define __STREXH(value, addr)    (uint32_t) (!__STC_H((short) value, (short *) addr))
 ...
 * @note    Keep RH850 function name and ensure identical behavior on RH850.
 */
#define __LDREXW(addr)           __LDL_W((int *) addr)
 ...
 * @note    Keep RH850 function name and ensure identical behavior on RH850.
 */
#define __STREXW(value, addr)    (uint32_t) (!__STC_W((int) value, (int *) addr))
 ...
 * @note    Keep RH850 function name and ensure identical behavior on RH850.
 */
#define __STREXB(value, addr)    (!__STC_B((char) value, (char *) addr))
 ...
 */
#define __SATADD(a, b)    __ADD_SAT((int) a, (int) b)
 ...
 */
#define __SATSUB(a, b)    __SUB_SAT((int) a, (int) b)
 ...
 */
__STATIC_FORCEINLINE uint32_t __BSH (uint32_t value)
{
    uint32_t result;
    __ASM volatile ("bsh  %1, %0" : "=&r" (result) : "r" (value) : "memory");
 ...
 * @return                Swapped value
 */
__STATIC_FORCEINLINE int32_t __BSW (int32_t value)
{
    int32_t result;
    __ASM volatile ("bsw  %1, %0" : "=&r" (result) : "r" (value) : "memory");
 ...
 */
#define __CLIPB(value)     __CLIP_B((int) value)
 ...
 * @return             Data in byte with saturation
 */
#define __CLIPBU(value)    __CLIP_BU((int) value)
 ...
 */
#define __CLIPH(value)     __CLIP_H((int) value)
 ...
 * @return             Data in haflword with saturation
 */
#define __CLIPHU(value)    __CLIP_HU((int) value)
 ...
 * @return                Swapped value
 */
__STATIC_FORCEINLINE int32_t __HSW (int32_t value)
{
    int32_t result;
    __ASM volatile ("hsw  %1, %0" : "=&r" (result) : "r" (value) : "memory");
 ...
 * @return             Bit position
 */
#define __SCH0L(value)    __SCH0L((int) value)
 ...
 * @return             Bit position
 */
#define __SCH0R(value)    __SCH0R((int) value)
 ...
 * @return                Bit position
 */
#define __SCH1L(value)    __SCH1L((int) value)
 ...
 * @return             Bit position
 */
#define __SCH1R(value)    __SCH1R((int) value)
 ...
 * @param [in]    bit  Bit position
 */
#define __CLR1(addr, bit)    __clr1(addr, bit)
 ...
 * @param [in]    bit  Bit position
 */
#define __SET1(addr, bit)    __set1(addr, bit)
 ...
 * @param [in]    bit  Bit position
 */
#define __NOT1(addr, bit)              __not1(addr, bit)
 ...
 */
#define __LDSR(regID, selID, value)    __LDSR((int) regID, (int) selID, (unsigned int) value)
 ...
 * @return             value of type uint8_t at (*addr)
 */
#define __LDLBU(addr)                  __LDL_BU((unsigned char *) addr)
 ...
 * @return        value of type uint16_t at (*ptr)
 */
#define __LDLHU(addr)                  __LDL_HU((unsigned short *) addr)

/**
 * @brief   Atomic load to system register
 * @details Loads a value into a system register atomically.
 * @param [in]    addr   Value to load
 */
#define __LDLW(addr)                   __LDL_W((int *) addr)
 ...
 * @return          1  Function failed
 */
#define __STCB(addr, value)            __STC_B((char) value, (char *) addr)
 ...
 * @return          1  Function failed
 */
#define __STCH(addr, value)            __STC_H((short) value, (short *) addr)
 ...
 */
#define __STCW(addr, value)            __STC_W((int) value, (int *) addr)
 ...
 */
#define __DBPUSH(regID1, regID2)       __DBPUSH((int) regID1, (int) regID2)
...
/** @}*/ /* end of group GHS_RH850_Core_InstructionInterface */
 ...
 *  @defgroup GHS_RH850_Core_RegAccFunctions GHS RH850-Core Register Access Functions
 *  @brief GHS RH850-Core Register Access Functions
 * @{
 */
