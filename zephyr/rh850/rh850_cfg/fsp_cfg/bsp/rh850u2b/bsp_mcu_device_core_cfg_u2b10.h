...
#ifndef BSP_MCU_DEVICE_CORE_CFG_U2B10_H_
#define BSP_MCU_DEVICE_CORE_CFG_U2B10_H_
 ...
 #define BSP_SYSTEM_RAM_CPU0_SIZE_BYTES     (65536)
#endif

/* Each bit represents a CPU core (e.g., CPU0 corresponds to bit 0) */
#ifndef BSP_DEVICE_CPU_AVAILABLE
 #define BSP_DEVICE_CPU_AVAILABLE           ((1 << 3U) | (1 << 2U) | (1 << 1U) | (1 << 0U))
#endif

#ifndef BSP_DEVICE_MAX_CPU
 #define BSP_DEVICE_MAX_CPU                 (3U)
#endif

#ifndef BSP_ENABLE_FXU
 #define BSP_ENABLE_FXU                     (1U)
#endif
...
#endif                                 /* BSP_MCU_DEVICE_CORE_CFG_U2B10_H_ */
