...
#define CANFD_CFG_TX_PRIORITY           (R_CANFD0_CFDGCFG_TPRI_Msk)
#define CANFD_CFG_DLC_CHECK             (0)
#define CANFD_CFD_CLOCK_SOURCE          (0)
#define CANFD_CFG_FD_OVERFLOW           (0)
#define CANFD_CFG_RXMB_NUMBER           (0x20)
#define CANFD_CFG_RXMB_SIZE             (0x7)
#define CANFD_CFG_GLOBAL_ERR_IPL                                               \
  DT_IRQ_BY_NAME(DT_INST(0, renesas_rh850_canfd_global), g_err, priority)
#define CANFD_CFG_RX_FIFO_IPL                                                  \
  DT_IRQ_BY_NAME(DT_INST(0, renesas_rh850_canfd_global), g_recc, priority)

#define CANFD_CFG_RXFIFO0_INT_THRESHOLD (0)
#define CANFD_CFG_RXFIFO0_DEPTH         (3)
#define CANFD_CFG_RXFIFO0_PAYLOAD       (7)
#define CANFD_CFG_RXFIFO0_INT_MODE      (R_CANFD0_CFDRFCC_RFIE_Msk | R_CANFD0_CFDRFCC_RFIM_Msk)
...
#define CANFD_CFG_RXFIFO1_INT_MODE      (R_CANFD0_CFDRFCC_RFIE_Msk | R_CANFD0_CFDRFCC_RFIM_Msk)
...
#define CANFD_CFG_RXFIFO2_INT_MODE      (R_CANFD0_CFDRFCC_RFIE_Msk | R_CANFD0_CFDRFCC_RFIM_Msk)
...
#define CANFD_CFG_RXFIFO3_INT_MODE      (R_CANFD0_CFDRFCC_RFIE_Msk | R_CANFD0_CFDRFCC_RFIM_Msk)
...
#define CANFD_CFG_RXFIFO4_INT_MODE      (R_CANFD0_CFDRFCC_RFIE_Msk | R_CANFD0_CFDRFCC_RFIM_Msk)
...
#define CANFD_CFG_RXFIFO5_INT_MODE      (R_CANFD0_CFDRFCC_RFIE_Msk | R_CANFD0_CFDRFCC_RFIM_Msk)
...
#define CANFD_CFG_RXFIFO6_INT_MODE      (R_CANFD0_CFDRFCC_RFIE_Msk | R_CANFD0_CFDRFCC_RFIM_Msk)
...
#define CANFD_CFG_RXFIFO7_INT_MODE      (R_CANFD0_CFDRFCC_RFIE_Msk | R_CANFD0_CFDRFCC_RFIM_Msk)
